...
| `feature/sim-femm/linear-solvers` | `crate/sim-lib-femm-solve` | 1 | Provide FEMM linear solver contracts, factor handles, dense fallback, iterative CG and BiCGSTAB kernels, and solve certificates. |
